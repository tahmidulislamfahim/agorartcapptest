                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    decoration: AppStyle.glassDecoration(
                      borderColor: notif.isRead ? AppColor.cardBorder : AppColor.primary.withOpacity(0.5),
                      bgColor: notif.isRead ? AppColor.cardBg : AppColor.primary.withOpacity(0.1),
                    ),
                    child: Row(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: Icon(
                            ...
                            color: isCallNotif ? AppColor.accentCall : AppColor.secondary,
                            size: 20,
                          ),
                        ),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  if (!notif.isRead)
                                    TextButton(
                                      onPressed: () => controller.markRead(notif.id),
                                      ...
                                      child: const Text(
                                        'Mark Read',
                                        style: TextStyle(color: AppColor.secondary, fontSize: 11),
                                      ),
                                    ),
                                ],
                              ),
                              ...
                              Text(
                                notif.createdAt.length > 16
                                    ...
                                    : notif.createdAt,
                                style: const TextStyle(color: AppColor.textDisabled, fontSize: 11),
                              ),
                            ],
                          ),
                        ),
